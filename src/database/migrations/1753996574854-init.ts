...
export class Init1753996574854 implements MigrationInterface {
    name = 'Init1753996574854'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "status" "public"."user_status_enum", "email" text, "last_login" TIMESTAMP, "password_hash_salt" text, "private_key_encrypted" text, "private_key_kdf_salt" text, "public_key" text, "key_created_at" TIMESTAMP, "domain" text, "type" character varying NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
